...
// v5.0 — Upsell rework: upsell_item_ids se fetch
// ✅ _triggerUpsellIfNeeded updated — upsellItemIds se directly fetch
// ✅ Cart limit preserved — max 20 items, max Rs.5000
...
class _MenuItemDetailScreenState extends State<MenuItemDetailScreen> {
  ...
  double get _heroH => MediaQuery.of(context).size.height * 0.42;
  ...
  void _showLimitSnackBar(CartProvider cart) {
    final msg = cart.totalItems >= CartProvider.maxTotalItems
            ...
            CustomScrollView(
              ...
              slivers: [
                ...
                if (!_isLoadingOthers && _otherItems.isNotEmpty)
                  SliverToBoxAdapter(
                    child: _buildMoreFromVendor(widget.vendor),
                  ),
        ...
        children: [
          ...
          _PortionRow(
            ...
            onAdd: () {
              ...
              CartUtils.handleCartAddItem(context, 
                item,
                widget.vendor,
                portionType: 'half',
                              ...
                              ? GestureDetector(
                                  onTap: () async {
                                    ...
                                    CartUtils.handleCartAddItem(
                                      ...
                                      widget.vendor,
                                      onLimitReached: () {
                                        _showLimitSnackBar(context.read<CartProvider>());
                                      },
                                      onSuccess: () async {
